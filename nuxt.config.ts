  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { hid: 'description', name: 'description', content: 'An AI-powered text summarization tool using Cloudflare Workers AI' },
        { name: 'format-detection', content: 'telephone=no' },
        // Open Graph / Facebook
        { property: 'og:type', content: 'website' },
        { property: 'og:title', content: 'AI Text Summarizer' },
        { property: 'og:description', content: 'An AI-powered text summarization tool using Cloudflare Workers AI' },
        { property: 'og:image', content: '/pdf-summarizer.png' },
        // Twitter
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'AI Text Summarizer' },
        { name: 'twitter:description', content: 'An AI-powered text summarization tool using Cloudflare Workers AI' },
